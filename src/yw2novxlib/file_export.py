...
class FileExport(Novel):
    ...
    def _get_fileHeaderMapping(self):
        ...
        projectTemplateMapping = dict(
            ...
            AuthorBio=self._convert_from_yw(self.authorBio),
    ...
    def _get_chapters(self):
        ...
        for chId in self.srtChapters:
            ...
            if self.chapters[chId].chType == 2:
                ...
                if self.chapters[chId].chLevel == 1:
                    ...
                    if inPart:
                        t = self._partEndTemplate
                    else:
                        t = ''
                        inPart = True
                    if self._todoPartTemplate:
                        template = Template(t + self._todoPartTemplate)
                ...
                if self.chapters[chId].chLevel == 1:
                    ...
                    if self._notesPartTemplate:
                        template = Template(t + self._notesPartTemplate)
            ...
            elif self.chapters[chId].chLevel == 1:
                if inPart:
                    t = self._partEndTemplate
                else:
                    t = ''
                    inPart = True
                if self._partTemplate:
                        template = Template(t + self._partTemplate)
            else:
            ...
            if self.chapters[chId].chType == 2:
                ...
                if self.chapters[chId].chLevel == 1:
                    # Chapter is "Todo Part" type.
                    pass
                elif self._todoChapterEndTemplate:
                ...
                if self.chapters[chId].chLevel == 1:
                    # Chapter is "Notes Part" type.
                    pass
                elif self._notesChapterEndTemplate:
        ...
        if inPart:
            lines.append(self._partEndTemplate)
        return lines
